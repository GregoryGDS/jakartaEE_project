                    ...
                    <ul class="list-group mb-3">
                        <c:forEach items="${basket}" var="basket">
                            <li class="list-group-item d-flex justify-content-between lh-sm">
                                <div>
                                    <h6 class="my-0">${basket.name}</h6>
                                    <small class="text-muted">${basket.content}</small>
                                </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input value="${user.name}" type="text" class="form-control" id="username" placeholder="Username" required="">
                                    <div class="invalid-feedback">
